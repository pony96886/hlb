...
class CalculateAfterLayout extends SingleChildRenderObjectWidget {
  const CalculateAfterLayout({Key? key, this.callback, Widget? child})
...
class RenderAfterLayout extends RenderProxyBox {
  ...
  void performLayout() {
    ...
    SchedulerBinding.instance
        .addPostFrameCallback((timeStamp) => callback?.call(this));
  }
